(define (problem imv-problem-2-final)
  ...
  (:init
    ...
    ;; NOTA: art_beta NON è presente qui. 
    ;; Questo significa che (transportable art_beta) è FALSO.
    ;; Raccoglierlo causerà (blocked ?agent).

    ;; --- SISMICITÀ ---
    ;; (seismic-active hall_b) <-- Decommentare se si vuole simulare attività sismica
  )
  ...
  (:goal
    (and
      ...
      ;; 2. Il Pod usato deve tornare al suo posto (Pods Room)
      (at pod1 pods_room)
